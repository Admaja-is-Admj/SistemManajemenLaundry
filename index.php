            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><span>Admaja Laundry </span></a>
                    </div>
                </div>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Admaja Laundry</h4>
                ...
                <footer class="footer text-right">
                    Copyright &copy; 2018 Rois Dwi Admaja.
                </footer>
            </div></div>
        <script>
            var resizefunc = [];
