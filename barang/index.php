...
<?php
    ...
    default:
        ...
        <tbody>";
    $i=1;
    $tp=mysqli_query($conn,"SELECT * FROM barangg ORDER BY id");
    ...
    break;
    case "edit":
        $edit = mysqli_query($conn,"SELECT * FROM barangg WHERE id='$_GET[id]'");
        ...
        echo '
            ...
            <div class="control-group">
                <div class="form-group">
                    ...
                    $tp=mysqli_query($conn,"SELECT * FROM supplier ORDER BY id");
                    while($r=mysqli_fetch_array($tp)){
